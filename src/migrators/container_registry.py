...
from services.registry_client import RegistryClient, RegistryConnectionError, ImageTransferError
from services.helm_client import HelmClient, HelmChartError
...
class ContainerRegistryMigrator(BaseMigrator):
    ...
    def __init__(self, config: MigrationConfig, console: MigrationConsole):
        ...
        self._source_client: Optional[RegistryClient] = None
        self._dest_client: Optional[RegistryClient] = None
        self._source_helm: Optional[HelmClient] = None
        self._dest_helm: Optional[HelmClient] = None
